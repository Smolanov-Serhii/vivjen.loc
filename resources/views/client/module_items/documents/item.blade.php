    ...
    <div class="breadcrumbs main-container">
        <div class="breadcrumbs__list">
            <ul class="breadcrumb">
                ...
                <span class="current-page">Документы</span>
                <span class="devider"> | </span>
        ...
        <div class="documents__container main-container">
            ...
            <div class="documents__content">
                ...
                <div class="documents__main">
                    ...
                    @isset($properties['item-file'])
{{--                    это @isset($var) это краткая форма записи для     --}}
{{--                    @if(isset($variable))--}}
                        <a href="{!! $properties['item-file'] !!}" class="documents__download" download="">
