    ...
    <div class="modal-dialog" id="modal_dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> @lang('block.variable') </h5>
...
{{--                    INPUT--}}
                    <div class="form-group">
                        <label for="order"> @lang('block_contents.sub_title')22 </label>
                        <input
                            id="sub_title"
                            name="sub_title"
                            type="text"
...
<div class="input-group mb-3" id="option_input" style="display: none">
    <input
        ...
        type="text"
        class="form-control input"
        placeholder="{{ __('block_contents.value') }}"
        autocomplete="off"
        value="22"
    >
